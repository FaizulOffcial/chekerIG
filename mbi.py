...
def main():
	...
	banner = f'''
{rdm} __  __ ___ ___ 
{rdm}|  \/  | _ )_ _| {W + B}| CREATOR : FAIZUL
{rdm}| |\/| | _ \| |  {W + B}| WHATSAPPS : 82271426251
{rdm}|_|  |_|___/___| {W + B}| COPYRINGT : CoLi +18 - {R + D}Indo{W + B}Sec{C}                
'''
	print(banner)
	...
	if cmd == "1":
		...
		os.system("xdg-open https://www.facebook.com/faizul.utama.3")
		os.system("clear")
		sys.exit()
